            ...
            <div class="collapse" id="collapseEvents">
                <div class="form-group mt-3">
                    <form  method="post" enctype="multipart/form-data"  th:action="@{/lectures}" th:object="${lecture}">
                        ...
                        <div class="form-group">
                            <select id = "lectorSelect" type="text" class="form-control bg-transparent"  name="lectors" placeholder="Lector" style="background-image: url(/img/BG_1_LB.png); color: #FFEACE;"
                                    th:field ="${lecture.lector}">
                                    <option th:each ="lector:${lectors}" th:value="${{lector}}" th:text="${lector.lastName}">Lector</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="lecture-details">
                                ...
                                <label class="custom-file-label " for="lectureDetails" style="background-image: url(/img/BG_1_LB.png); color: #FFEACE;">Choose file</label>
                            </div>
                        </div>
