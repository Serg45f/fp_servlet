...
height:100vh;">
     ...
     <div class="form-group mt-3">
          <form accept-charset="UTF-8" method="post" enctype="application/x-www-form-urlencoded" action="${pageContext.request.contextPath}/controller?command=vehicle_save">
