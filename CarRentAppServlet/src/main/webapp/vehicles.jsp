                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-8">
                                <div class="card-body row">
                                    <div class="col-md-8">
                                        <h4 class="card-title">
                                            <fmt:message key="vehicle.carModel.name" bundle="${rb}"/>
                                    ...
                                    <c:if class="col-md-4">
                                        ...
                                        <c:if test = "${loggedUserRoles.contains(roles['ADMIN'])}">
                                            <p>
                                                <a href="${pageContext.request.contextPath}/vehicles/edit/${vehicle.id}" class="btn btn-transparent btn-outline-success col-sm-12 px-0" >Edit</a>
                                            </p>
                                            <p>
                                                <a  href="${pageContext.request.contextPath}/vehicles/delete/${vehicle.id}" class="btn btn-transparent btn-outline-danger col-sm-12 px-0" >Delete</a>
                                            </p>
                                        </c:if>
                                    </div>
                                </div>
